...
enforce("entry JavaScript raw", script.raw, 700_000); enforce("entry JavaScript gzip", script.gzip, 130_000); enforce("renderer CSS raw", css.raw, 34_000); enforce("renderer CSS gzip", css.gzip, 10_000);
...
console.log(JSON.stringify({ entryJavaScript: script, css, budgets: { entryRaw: 700_000, entryGzip: 130_000, cssRaw: 34_000, cssGzip: 10_000 } }));
