...
- [VS Code extension implementation plan](superpowers/plans/2026-04-14-vscode-extension.md)

The source code and automated tests are the authority for current behavior. Planning documents describe intent and may include work that has not shipped.
